...
function whatsappEscalationReply(order) {
  ...
  return "I'm sorry this has taken longer than expected. Your issue has been under manual review for more than 3 hours" + reference + ". Please contact our support team directly on WhatsApp so we can follow up with you personally. Please include your order reference and don't make another payment.";
}
