...
function whatsappEscalationReply(order) {
  ...
  if (WHATSAPP_SUPPORT_URL) {
    return "I'm sorry this has taken longer than expected. Your issue has been under manual review for more than 3 hours" + reference + ". At this point, please contact our support team directly on WhatsApp so we can follow up with you personally. You can reach us here: " + WHATSAPP_SUPPORT_URL + ". Please include your order reference and don't make another payment.";
  }
